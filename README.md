...
To enable GitHub for DevRev, click on Install and we'll walk you through a few simple  including connecting with GitHub. You'll have a default set of configuration settings and the option to further personalize this snap-in. Learn more  the features in this snap-in.
